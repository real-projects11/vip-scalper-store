...
(function () {
  ...
  // Este script se inyecta de forma DINÁMICA (después de que la página ya
  // cargó), así que 'DOMContentLoaded' ya disparó hace rato y nunca íbamos a
  // enterarnos — por eso el botón "Comprar ahora" no hacía nada. Si el
  // documento ya está listo, corremos el init de una; si no, esperamos igual.
  function init() {
