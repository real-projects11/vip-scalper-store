...
//
// Una vez que uses el botón, podés borrar este archivo junto con
// pages/api/admin/seed-vip-scalper.js — no hacen falta para el
// funcionamiento normal de la tienda.
        ...
        >
          {result.ok
            ? result.data.alreadyExisted
              ? 'ℹ️ Ese producto ya existía — no se creó de nuevo. Andá a /admin y buscalo en la lista.'
              : `✅ Listo — se creó "${result.data.product.title}" (slug: ${result.data.product.slug}), ya activo. Andá a /admin para verlo o editarlo.`
