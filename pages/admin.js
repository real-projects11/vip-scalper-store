...
export default function Admin() {
  ...
  return (
    <div style={{ maxWidth: 640, margin: '0 auto', padding: '32px 20px 60px', fontFamily: '-apple-system, Inter, sans-serif', color: '#111' }}>
      <h1 style={{ fontSize: 22, fontWeight: 800, marginBottom: 4 }}>Panel — VIP Scalper</h1>
      <a href="/admin/edit" style={{ display: 'inline-block', marginBottom: 24, fontSize: 12.5, fontWeight: 700, color: '#12664F' }}>✎ Editar la página de producto →</a>
